    ...
    <main class="main-content">
      ...
      <div id="section-1" class="section">
        ...
        <div class="contact-info icon">
          ...
          <a href="https://github.com/taegyeong0225" target="_blank">github</a>
        </div>
      </div>
      <!-- 학력 -->
      <div id="section-1" class="section">
        ...
        <div class="awards-info icon">
          <table>
            ...
            <tbody>
              <tr>
                <td>2024.02.01</td>
                <td>2023 WOW(World Of Wisdom) 캠프(2) (은상)</td>
                <td>인하공업전문대학</td>
              </tr>
              <tr>
                <td>2023.11.30</td>
                <td>제 21 회 독후감경진대회 (장려상)</td>
                <td>인하공업전문대학</td>
              </tr>
              <tr>
                <td>2023.08.25</td>
              ...
              <tr>
                <td>2021.12.31</td>
                <td>표창장 (청소년 운영 위원회 활동)</td>
                <td>인천광역시서구청장</td>
              </tr>
              <tr>
                <td>2021.09.08</td>
                <td>제 23 회 전국중고생자원봉사대회 (동상)</td>
                <td>KB 라이프생명사회공헌재단</td>
              </tr>
            </tbody>
          </table>
        </div>
      ...
      <div id="section-4" class="section">
        ...
        <div class="awards-info icon">
          <table>
            ...
            <tbody>
              <tr>
                <td>2024.07.01~2024.08.30</td>
                <td>부스트코스 data science 2024 - 리드부스터</td>
                <td>네이버 커넥트재단</td>
              </tr>
              <tr>
